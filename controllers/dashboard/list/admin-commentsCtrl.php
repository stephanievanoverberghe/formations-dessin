...
try {
    ...
    $unvalidateComments = Comment::getUnvalidatedComment();
    $validateComments = Comment::getAllValidateComments();
    ...
    $comments = Comment::getAll($search, $limit, $offset);
    
    $nbPageTotal = Comment::getAllCount($search);
