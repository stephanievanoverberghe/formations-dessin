                    ...
                    <div class="col-md-10">
                        ...
                        <form class="mb-5 formVideo" role="form" id="formVideo" method="POST">
                            <div class="form mb-4">
                                ...
                                <label 
                                    for="title" 
                                    class="form_label orange mt-5 mb-2"
                                    >Titre
                                ...
                                <input 
                                    class="form-control form-control-lg <?= isset($errors['file']) ? 'is-invalid' : '' ?>" 
                                    id="video" 
                                    type="file" 
                                    name="file" 
                                    value="<?= $video->file ?? $file ?? '' ?>">
                                <div class="error"><?= $errors['file'] ?? '' ?></div>
                                <!-- VALIDATE FORM -->
                                <div class="mt-3">
                                    <a href="/controllers/dashboard/list/admin-videosCtrl.php"><i class="bi bi-arrow-left-circle-fill"></i> Retour</a>
                                </div>
