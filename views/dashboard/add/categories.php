            ...
            <div id="addCategory">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        ...
                        <!-- START FORM -->
                        <form class="mb-5 formCategory" role="form" id="formCategory" method="POST">
                            <div class="form mb-4">
                                <!-- TITLE -->
                                ...
                                <input type="text" value="<?= $category->slug ?? $slug ?? '' ?>" class="form-control <?= isset($errors['slug']) ? 'is-invalid' : '' ?>" id="slug" name="slug" required>
