                ...
                <div class="col-md-10">
                    ...
                    <form 
                        ...
                        <div class="form mb-4">
                            ...
                            <input 
                                type="text"
                                value="<?= $article->subTitleOne ?? $subTitleOne ?? '' ?>"
                                class="form-control <?= isset($errors['subTitleOne']) ? 'is-invalid' : ''?>"
                                id="subTitleOne"
                                name="subTitleOne"
                                required
                            >
                            ...
                            <input 
                                type="text"
                                value="<?= $article->subTitleTwo ?? $subTitleTwo ?? '' ?>"
                                class="form-control <?= isset($errors['subTitleOne']) ? 'is-invalid' : ''?>"
                                id="subTitleTwo"
                                name="subTitleTwo"
                                required
