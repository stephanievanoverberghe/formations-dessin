        ...
        <div class="container">
            <div id="addModule">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <h1 class="mb-5 text-center"><?= (isset($id_modules)) ? 'Modifier le' : 'Ajouter un' ?> module</h1>
                        <!-- START FORM -->
                        <form class="mb-5 formModule" role="form" id="formModule" method="POST">
                            <div class="form mb-4">
                                <!-- TITLE -->
                                <label for="title" class="form_label orange mt-5 mb-2">Titre
                                    <span class="orange"> *</span>
                                </label>
                                <input type="text" value="<?= $module->title ?? $title ?? '' ?>" class="form-control <?= isset($errors['title']) ? 'is-invalid' : '' ?>" id="title" name="title" required>
                                <div class="error"><?= $errors['title'] ?? '' ?></div>
                                <!-- CONTENT -->
                                <label for="content" class="form_label orange mt-5 mb-2">Contenu
                                    <span class="orange"> *</span>
                                </label>
                                <textarea class="form-control" name="content" id="content" rows="10" required><?= $module->content ?? $content ?? '' ?></textarea>
                                <div class="error"><?= $errors['content'] ?? '' ?></div>
                                <!-- FORMATION -->
                                <label for="id_trainings" class="form-label orange mt-5 mb-2">Formation *</label>
                                <select name="id_trainings" id="id_trainings" class="form-select" required>
                                    <?php
                                ...
                                <div class="col-12 text-center">
                                    <input class="btn mt-5 mb-2" type="submit" value="Valider"></input>
                                </div>
                                <div class="col-12">
