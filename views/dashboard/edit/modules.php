        ...
        <section id="editModule">
            <div class="container">  
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <h1 class="text-center mb-5"><?= htmlentities($module->title) ?? $title ?? '' ?></h1>
                    </div>
                </div>
                <div class="row justify-content-center editModule px-4 py-5">
                    <div>
                        <div class="col-12">
                            <h2>Contenu</h2>
                            <p><?= htmlentities($module->content) ?? $content ?? '' ?></p>
                        </div>
                        <div class="col-12">
                            <h2 class="mt-5">Créé le</h2>
                            <p><?= htmlentities(date('d.m.Y', strtotime($module->created_at))) ?? $created_at ?? '' ?></p>
                            <h2 class="mt-5">Modifié le</h2>
                            <p><?= htmlentities(date('d.m.Y', strtotime($module->updated_at))) ?? $updated_at ?? '' ?></p>
