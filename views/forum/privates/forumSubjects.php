<main>
                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="/controllers/forum/privates/forumSubmodulesCtrl.php">La droite</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Un autre moyen de tracer des droites</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section id="topics">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="addTopics text-end mt-5 mb-4">
