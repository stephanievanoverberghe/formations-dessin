            ...
            <form method="post" role="form" id="formUser" class="formUser">
                <div class="container">
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mt-lg-5 mb-lg-3 col-12 mt-5 ">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-lg-3 col-12 mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-lg-3 col-12 my-5 ">
                                <label for="passwordCheck" class="form-label">Confirmation du mot de passe
                                    <span class="orange"> *</span>
                                </label>
                                <input 
                                    type="password" 
                        ...
                        ?>
                            <div class="offset-lg-2 my-3 form-check">
                                <input 
                                    ...
                                    id="legal_notice<?= $key ?>" 
                                    value="<?= $key ?>" <?= (isset($checkLegalNotice) && in_array($key, $checkLegalNotice)) ? 'checked' : '' ?>
                                >
