        ...
        <div class="container">
            <div class="row">
                <div class="col-6 text-md-start mt-5">
                    <a href="/controllers/formation/module5Ctrl.php?id_trainings=<?= $id_trainings ?>&id_modules=<?= $id_modules - 1 ?>"><i class="bi bi-arrow-left-circle-fill me-4"></i>Module 5 - Textures et matières</a>
                </div>
                <div class="col-6 text-md-end mt-5">
                    <a href="/controllers/formation/exerciceCtrl.php?id_trainings=<?= $id_trainings ?>&id_modules=<?= $id_modules ?>">Exercice final<i class="bi bi-arrow-right-circle-fill ms-4"></i></a>
                </div>
            </div>
