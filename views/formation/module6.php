                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Module 6</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-5">
                    <p>Une composition puissante exerce une attraction intuitive sur l'observateur.</p>
                    <p>Il existe de nombreuses règles en la matière.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-md-end mt-5">
                    <a href="/controllers/formation/exerciceCtrl.php">Exercice final</a>
                </div>
            </div>
