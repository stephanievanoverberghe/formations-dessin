                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Module 4</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-5">
                    <p>Pour rendre le volume d'un objet ou toutes les choses que nous souhaitons dessiner, il est très important d'avoir des bases solides en termes d'ombre et de lumière.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-md-end mt-5">
                    <a href="/controllers/formation/module5Ctrl.php">Module 5 - Textures et matières</a>
                </div>
            </div>
