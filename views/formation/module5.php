                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Module 5</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-5">
                    <h2>Textures et matières</h2>
                </div>
                <div class="col-12 mb-5">
                    <p>Avec les textures et la matières, nous entrons dans les détails du dessin réaliste.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 text-md-start mt-5">
                    <a href="/controllers/formation/module4Ctrl.php">Module 4 - Ombres et lumières</a>
                </div>
