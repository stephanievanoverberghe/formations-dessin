        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-5">
                    <h2>Observer en 2d</h2>
                </div>
                <div class="col-12 mb-5">
                    <p>Dessiner, c'est avant tout "OBSERVER".</p>
                    <p>Si tu es capable de regarder un modèle et de le voir tel qu'il est en face de toi, la moitié du chemin est parcourue.</p>
                    <p>Le reste n'est qu'une question de technique et de pratique.</p>
                    <p>La difficulté, c'est d'oublier ce que nous savons pour laisser place à ce que nous voyons vraiment.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 text-md-start mt-5">
                    <a href="/controllers/formation/module1Ctrl.php">Module 1 - Matériels</a>
                </div>
                <div class="col-6 text-md-end mt-5">
                    <a href="/controllers/formation/module3Ctrl.php">Module 3 - Observer en 3d</a>
                </div>
            </div>
