                ...
                <div class="col">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Module 3</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-5">
                    <h2>Observer en 3d</h2>
                </div>
                <div class="col-12 mb-5">
                    <p>La perspective est un fondamentaux du dessin réaliste. Elle est partout autour de nous.</p>
                </div>
            </div>
        </div>
    </section>
